...
DEVICE_ID="${DEVICE_ID:-${PI_DEVICE_ID:-$DEFAULT_DEVICE_ID}}"
...
[[ -n "${PI_DEVICE_ID:-}" ]] && ok "PI_DEVICE_ID is set (${PI_DEVICE_ID})" || warn "PI_DEVICE_ID not set (using hostname fallback: ${DEVICE_ID})"
